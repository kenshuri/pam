...
ALLOWED_HOSTS = ['127.0.0.1',
                 'pam-dev.up.railway.app',
                 'petites-annonces-musique.fr']
...
DEFAULT_FROM_EMAIL = "Petites Annonces Musique <ne-pas-repondre@petites-annonces-musique.fr>"


# HTMX
CSRF_TRUSTED_ORIGINS = ['https://petites-annonces-musique.fr',
                        'https://pam-dev.up.railway.app']
